...
export default class App extends Component {
  ...
  saveTodo = e => {
    ...
    const moreInfoValue = this.moreInfoElement.value;

    console.log(moreInfoValue);
      ...
      <div className="app">
        ...
        <div className="todo-list">
          ...
          <form className="todo-create-wrapper" onSubmit={this.saveTodo}>
            ...
            <input
              className="todo-create-input"
              placeholder="Add some more information (optional)"
              name="more-info"
              ref={el => (this.moreInfoElement = el)}
              autoComplete="off"
              style={{ marginRight: 20 }}
            />
